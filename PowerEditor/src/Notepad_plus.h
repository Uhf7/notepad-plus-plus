...
public:
	...
	BufferID doOpen(const generic_string& fileName, bool isRecursive = false, bool isReadOnly = false, int encoding = ENC_NEW, const TCHAR *backupFileName = NULL, FILETIME fileNameTimestamp = {});
