...
public:
	...
	BufferID doOpen(const generic_string& fileName, bool isRecursive = false, bool isReadOnly = false, int encoding = -2, const TCHAR *backupFileName = NULL, FILETIME fileNameTimestamp = {});
